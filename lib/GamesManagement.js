...
GamesManagement.prototype = {
        ...
        try {
            switch (messageData.messageType) {
                ...
                case "addShip":
                    ...
                    var game = this._games[messageData.message.gameKey];
                    game.addShip(messageData.message.playerKey, messageData.message.type, messageData.message.x, messageData.message.y);
                    break;
            }
        } catch (e) {
            console.log(e);
    ...
    leaveGame: function (playerKey, gameKey) {
        ...
        playersKeys.forEach(function (playerKey) {
            playerKey.sendUTF(this.sendMessage("disconnect", true));
        });
